            ...
            <ul id="revolutionul" style="display:none;">
                ...
                ?>
                        ...
                        <li data-transition="fade" data-slotamount="8" data-masterspeed="700" data-delay="5000" data-thumb="">
                            <div class="caption lfl slide_item_left" data-x="10" data-y="70" data-speed="400" data-start="0" data-easing="easeOutBack">
                                <img src="<?php echo $slide->img_url; ?>" alt="Image 1">
                            </div>
                            <div class="caption lfr slide_title" data-x="670" data-y="120" data-speed="400" data-start="0" data-easing="easeOutExpo">
                                <?php echo $slide->text1; ?>
                            </div>

                            <div class="caption lfr slide_subtitle dark-text" data-x="670" data-y="190" data-speed="400" data-start="500" data-easing="easeOutExpo">
                                <?php echo $slide->text2; ?>
                            </div>
                            <div class="caption lfr slide_desc" data-x="680" data-y="260" data-speed="400" data-start="500" data-easing="easeOutExpo">
    ...
    <div class="container">
        ...
        <div class="row appointment" style="display: none;">
            ...
            <div class="modal-body">
                <form role="form" action="request" class="clearfix" method="post">
                    <div class="col-md-6">
                        <div class="clearfix">
                    ...
                    <?php foreach ($services as $service) { ?>
                        <div class="col-lg-4 col-sm-6">
                            <div class="content" style="text-align: center; margin: 50px 0px;">
                                <span class="clearfix"><img style="height: 100px; border-radius: 100px; margin-bottom: 25px;" src="<?php if (!empty($service->img_url)) {
                            ...
                            <div class="col-lg-3 col-sm-3">
                                <div class="pricing-table">
                                    <div class="pricing-head">
                                        ...
                                        <h2>
                                            <?php echo $package1->price; ?>
                                            <span class="note"> <?php echo $this->db->get('settings')->row()->currency; ?></span>
                                        </h2>
                                    </div>
