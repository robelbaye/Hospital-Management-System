                        ...
                        <form role="form" id="editLabForm" class="clearfix" action="lab/addLab" method="post" enctype="multipart/form-data">
                            ...
                            <div class="">
                                <div class="col-md-6 lab pad_bot">
                                    ...
                                    <input type="text" class="form-control pay_in default-date-picker" name="date" value='
                                    <?php
                                    if (!empty($lab->date)) {
                                ...
                                <div class="pos_client">
                                    ...
                                    <div class="col-md-8 lab pad_bot">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control pay_in" name="p_email" value='
                                            <?php
                                    ...
                                    <div class="col-md-8 lab pad_bot">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control pay_in" name="p_phone" value='
                                            <?php
                                    ...
                                    <div class="col-md-8 lab pad_bot">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control pay_in" name="p_age" value='
                                            <?php
                                            if (!empty($lab->p_age)) {
                                                echo $lab->p_age;
                                            }
                                ...
                                <div class="pos_doctor">
                                    <div class="col-md-8 lab pad_bot">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control pay_in" name="d_name" value='
                                            <?php
                                            if (!empty($lab->p_name)) {
                                                echo $lab->p_name;
                                            }
                                    ...
                                    <div class="col-md-8 lab pad_bot">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control pay_in" name="d_email" value='
                                            <?php
                                            if (!empty($lab->p_email)) {
                                                echo $lab->p_email;
                                            }
                                    ...
                                    <div class="col-md-8 lab pad_bot">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" class="form-control pay_in" name="d_phone" value='
                                            <?php
                                            if (!empty($lab->p_phone)) {
                                                echo $lab->p_phone;
                                            }
                            ...
                            <?php if ($this->ion_auth->in_group(array('Doctor'))) { ?>
                                <div class="col-md-12 lab pad_bot">
                                    <label for="exampleInputEmail1"> <?php echo lang('report'); ?></label>
                                    <textarea class="ckeditor form-control" id="editor" name="report" value="" rows="10" readonly="">
                                        <?php
                                        if (!empty($setval)) {
                                            echo set_value('report');
                                        }
