            ...
            <div class="panel panel-primary">
                ...
                <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="col-lg-4 invoice-block pull-right">
                                <ul class="unstyled amounts">
                                    <li><strong><?php echo lang('sub_total_amount'); ?> : </strong><?php echo $this->db->get('settings')->row()->currency; ?> <?php
                                        if (!empty($amount)) {
                    ...
                    <div class="row">
                        <div class="col-lg-4 invoice-block pull-right">
                            <ul class="unstyled amounts">         
                                <li style="background: yellow;"><strong><?php echo lang('total_amount_to_be_paid'); ?> : </strong><?php echo $this->db->get('settings')->row()->currency; ?> <?php
