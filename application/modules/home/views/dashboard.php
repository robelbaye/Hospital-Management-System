...
if (!$this->ion_auth->in_group(array('superadmin'))) {
    ...
    <head>
        ...
        <title> <?php echo $this->router->fetch_class(); ?> | 
            ...
            $this->db->get('settings')->row()->title;
            ?>
            <?php echo $settings=$this->db->get('settings')->row()->title; ?>   
        </title>
        <!-- Bootstrap core CSS -->
                    ...
                    <a href="" class="logo">
                        <strong>
                            <?php
                             $settings_title = $this->db->get('settings')->row()->title;
                             $settings_title = explode(' ', $settings_title);?>
                            <?php echo $settings_title[0]; ?>&nbsp<span><?php
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin'))) { ?>
                            <?php if (in_array('doctor', $this->modules)) { ?>
                                <li> <li class="sub-menu">
                                    ...
                                    <ul class="sub">
                                        <li><a href="doctor"><i class="fa fa-stethoscope"></i><?php echo lang('list_of_doctors'); ?></a></li>
                                        <li><a href="appointment/treatmentReport"><i class="fa fa-list-alt"></i><?php echo lang('treatment_history'); ?></a></li>
                                    </ul>
                                </li>
                            <?php } ?>
                        <?php } ?>
                        <?php if ($this->ion_auth->in_group(array('admin', 'Nurse', 'Doctor', 'Laboratorist', 'Receptionist'))) { ?>
                            <?php if (in_array('patient', $this->modules)) { ?>
                                <li> <li class="sub-menu">
                                    ...
                                    <ul class="sub"> 
                                        <li><a href="patient"><i class="fa fa-wheelchair"></i><?php echo lang('patient_list'); ?></a></li>
                                        ...
                                        <?php if (!$this->ion_auth->in_group(array('Accountant', 'Receptionist'))) { ?>
                                            <li><a href="patient/caseList"><i class="fa fa-list-alt"></i><?php echo lang('case'); ?> <?php echo lang('manager'); ?></a></li>
                                            <li><a href="patient/documents"><i class="fa fa-file-o"></i><?php echo lang('documents'); ?></a></li>
                                        <?php } ?>
                                    </ul>
                                </li>
                            <?php } ?>
                            ...
                            <?php if (in_array('appointment', $this->modules)) { ?>
                                <li> <li class="sub-menu">
                                    ...
                                    <ul class="sub"> 
                                        ...
                                        <li><a href="appointment/addNewView"><i class="fa fa-plus-square-o"></i><?php echo lang('add'); ?></a></li>
                            ...
                            <li> <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    <?php if (in_array('nurse', $this->modules)) { ?>
                                        <li><a href="nurse"><i class="fa fa-plus-square-o"></i><?php echo lang('nurse'); ?></a></li>
                                    <?php } ?>
                                    <?php if (in_array('pharmacist', $this->modules)) { ?>
                                        <li><a href="pharmacist"><i class="fa fa-plus-square-o"></i><?php echo lang('pharmacist'); ?></a></li>
                                    <?php } ?>
                                    <?php if (in_array('laboratorist', $this->modules)) { ?>
                                        <li><a href="laboratorist"><i class="fa fa-plus-square-o"></i><?php echo lang('laboratorist'); ?></a></li>
                                    <?php } ?>
                                    <?php if (in_array('accountant', $this->modules)) { ?>
                                        <li><a href="accountant"><i class="fa fa-plus-square-o"></i><?php echo lang('accountant'); ?></a></li>
                                    <?php } ?>
                                    <?php if (in_array('receptionist', $this->modules)) { ?>
                                        <li><a href="receptionist"><i class="fa fa-plus-square-o"></i><?php echo lang('receptionist'); ?></a></li>
                                    <?php } ?>
                                </ul>
                            </li>
                        <?php } ?>
                        <?php if ($this->ion_auth->in_group('admin')) { ?>
                            <?php if (in_array('finance', $this->modules)) { ?>
                                <li class="sub-menu">
                                    ...
                                    <ul class="sub">
                                        <li><a  href="finance/payment"><i class="fa fa-dollar"></i> <?php echo lang('payments'); ?></a></li>
                                        <li><a  href="finance/addPaymentView"><i class="fa fa-plus-square-o"></i><?php echo lang('add_payment'); ?></a></li>
                                        <li><a  href="finance/paymentCategory"><i class="fa fa-edit"></i><?php echo lang('payment_procedures'); ?></a></li>
                                        <li><a  href="finance/expense"><i class="fa fa-dollar"></i><?php echo lang('expense'); ?></a></li>
                                        <li><a  href="finance/addExpenseView"><i class="fa fa-plus-square-o"></i><?php echo lang('add_expense'); ?></a></li>
                            ...
                            <?php if (in_array('medicine', $this->modules)) { ?>
                                <li class="sub-menu">
                                    ...
                                    <ul class="sub">
                                        ...
                                        <li><a  href="medicine/addMedicineView"><i class="fa fa-plus-square-o"></i><?php echo lang('add_medicine'); ?></a></li>
                                        <li><a  href="medicine/medicineCategory"><i class="fa fa-edit"></i><?php echo lang('medicine_category'); ?></a></li>
                                        <li><a  href="medicine/addCategoryView"><i class="fa fa-plus-square-o"></i><?php echo lang('add_medicine_category'); ?></a></li>
                                ...
                                <li class="sub-menu">
                                    ...
                                    <ul class="sub">
                                        <?php if (!$this->ion_auth->in_group(array('Pharmacist'))) { ?>
                                            <li><a  href="finance/pharmacy/home"><i class="fa fa-dashboard"></i> <?php echo lang('dashboard'); ?></a></li>
                                        <?php } ?>
                                        <li><a  href="finance/pharmacy/payment"><i class="fa fa-dollar"></i> <?php echo lang('sales'); ?></a></li>
                                        <li><a  href="finance/pharmacy/addPaymentView"><i class="fa fa-plus-square-o"></i><?php echo lang('add_new_sale'); ?></a></li>
                                        <li><a  href="finance/pharmacy/expense"><i class="fa fa-dollar"></i><?php echo lang('expense'); ?></a></li>
                                        <li><a  href="finance/pharmacy/addExpenseView"><i class="fa fa-plus-square-o"></i><?php echo lang('add_expense'); ?></a></li>
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin', 'Laboratorist'))) { ?>
                            <?php if (in_array('donor', $this->modules)) { ?>
                                <li class="sub-menu">
                                    ...
                                    <ul class="sub">
                                        <li><a  href="donor"><i class="fa fa-list-alt"></i><?php echo lang('donor_list'); ?></a></li>
                                        <li><a  href="donor/addDonorView"><i class="fa fa-plus-square-o"></i><?php echo lang('add_donor'); ?></a></li>
                            ...
                            <?php if (in_array('bed', $this->modules)) { ?>
                                <li class="sub-menu">
                                    ...
                                    <ul class="sub">
                                        ...
                                        <li><a  href="bed/addBedView"><i class="fa fa-plus-square-o"></i><?php echo lang('add_bed'); ?></a></li>
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin', 'Nurse', 'Laboratorist', 'Doctor'))) { ?>
                            <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    ...
                                    <?php if ($this->ion_auth->in_group(array('admin'))) { ?>
                                        <?php if (in_array('finance', $this->modules)) { ?>
                                            <li><a  href="finance/doctorsCommission"><i class="fa fa-dollar"></i><?php echo lang('doctors_commission'); ?> </a></li>
                                        <?php } ?>
                                    <?php } ?>
                                </ul>
                            </li>
