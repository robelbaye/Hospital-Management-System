                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-samples">
                        ...
                        <tbody>
                            ...
                            <tr class="total">
                                ...
                                <td> <strong> <?php echo $total_p; ?> <?php echo $this->db->get('settings')->row()->currency; ?></strong></td>
                                <td> <strong> <?php echo $total_d; ?> <?php echo $this->db->get('settings')->row()->currency; ?></strong></td>
