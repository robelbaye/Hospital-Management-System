    ...
    function getPayment() {
        ...
        foreach ($data['payments'] as $payment) {
            ...
            $info[] = array(
                ...
                $doctor,
                $date,
                $this->db->get('settings')->row()->currency . '' . $payment->amount,
                $this->db->get('settings')->row()->currency . '' . $discount,
                $this->db->get('settings')->row()->currency . '' . $payment->gross_total,
                $this->db->get('settings')->row()->currency . '' . $this->finance_model->getDepositAmountByPaymentId($payment->id),
                $this->db->get('settings')->row()->currency . '' . ($payment->gross_total - $this->finance_model->getDepositAmountByPaymentId($payment->id)),
                $payment->remarks,
